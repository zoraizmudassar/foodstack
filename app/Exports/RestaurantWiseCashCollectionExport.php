...
class RestaurantWiseCashCollectionExport implements  FromView, ShouldAutoSize, WithStyles ,WithHeadings, WithEvents
{
    ...
    {
        return view('file-exports.restaurant-wise-cash-collection', [
            'data' => $this->data,
        ]);
    }
