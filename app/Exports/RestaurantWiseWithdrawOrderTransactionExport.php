...
class RestaurantWiseWithdrawOrderTransactionExport implements  FromView, ShouldAutoSize, WithStyles ,WithHeadings, WithEvents
{
    ...
    {
        return view('file-exports.restaurant-wise-withdraw-order-transaction', [
            'data' => $this->data,
        ]);
    }
