...
class SubscriptionTransactionsExport implements FromView, ShouldAutoSize, WithStyles,WithColumnWidths ,WithHeadings, WithEvents
{
    use Exportable;
    protected $data;
    ...
    {
        return view('file-exports.subscription_transactions', [
            'data' => $this->data,
        ]);
    }
