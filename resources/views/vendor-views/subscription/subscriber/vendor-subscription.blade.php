...
<div class="content container-fluid">
            ...
            <div class="flex-grow-1">
                <div class="d-flex align-items-start">
                    ...
                    <div class="w-0 flex-grow pl-2">
                        <h1 class="page-header-title">{{ $restaurant->name }} {{translate('Business_Plan')}} &nbsp; &nbsp;
    ...
    @if ($restaurant->restaurant_all_sub_trans_count > 0)
            ...
            <div class="__bg-F8F9FC-card __plan-details">
                <div class="d-flex flex-wrap flex-md-nowrap justify-content-between __plan-details-top">
                    <div class="w-100">
                        ...
                        <h4 class="title mt-2"><span class="text-180">{{ $restaurant->comission > 0 ?  $restaurant->comission :  $admin_commission }} %</span> {{ translate('messages.Commission_per_order') }}</h4>                        <div class="info-text ">
    ...
    @elseif (in_array($restaurant->restaurant_model,[ 'subscription' ,'unsubscribed']) && $restaurant?->restaurant_sub_update_application)
        ...
        <div class="card mb-20">
            <div class="card-header border-0 align-items-center">
                <h4 class="card-title align-items-center gap-2">
                    <span class="card-header-icon">
                        <img src="{{dynamicAsset('public/assets/admin/img/billing.png')}}" alt="">
                    </span>
                ...
                <div class="row g-3">
                    <div class="col-sm-6 col-lg-4">
                        <a class="__card-2 __bg-1 flex-row align-items-center gap-4" href="#">
                            <img src="{{dynamicAsset('public/assets/admin/img/expiring.png')}}" alt="report/new" class="w-60px">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="__card-2 __bg-8 flex-row align-items-center gap-4" href="#">
                            <img src="{{dynamicAsset('public/assets/admin/img/total-bill.png')}}" alt="report/new" class="w-60px">
                            <div class="w-0 flex-grow-1 py-md-3">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="__card-2 __bg-4 flex-row align-items-center gap-4" href="#">
                            <img src="{{dynamicAsset('public/assets/admin/img/number.png')}}" alt="report/new" class="w-60px">
                            <div class="w-0 flex-grow-1 py-md-3">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body pt-0">
                ...
                {{-- {{ dd($restaurant?->restaurant_sub_update_application) }} --}}
                <div class="btn--container justify-content-end mt-3">
                    @if ( $restaurant?->restaurant_sub_update_application?->is_canceled == 0 && $restaurant?->restaurant_sub_update_application?->status == 1  )
                        <button type="button"  data-url="{{route('vendor.subscriptionackage.cancelSubscription',$restaurant?->id)}}" data-message="{{translate('If_you_cancel_the_subscription,_after_')}} {{  Carbon\Carbon::now()->diffInDays($restaurant?->restaurant_sub_update_application?->expiry_date_parsed->format('Y-m-d'), false); }} {{ translate('days_the_you_will_no_longer_be_able_to_run_the_business_before_subscribe_a_new_plan.') }} "
                            ...
                            <div class="__plan-item hover {{ $restaurant?->restaurant_sub_update_application?->package_id == $package->id  && $restaurant->restaurant_model != 'commission'  ? 'active' : ''}}">
                                <div class="inner-div">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button data-id="{{ $package->id }}"  data-url="{{route('vendor.subscriptionackage.packageView',[$package->id,$restaurant->id ])}}"
...
@push('script_2')
    <script>
        ...
        var url = '{{ route('vendor.subscriptionackage.packageView',[$restaurant?->restaurant_sub?->package_id,$restaurant->id ]) }}';
        package_pay(url);
