            ...
            <tr>
                ...
                <td>
                    <div style="text-align: end; margin-inline-end:15px;">
                        <img style="max-width:250px;border:0;" src="{{dynamicStorage('/storage/app/public/business/'.$logo)}}" title=""
                    ...
                    <div style="text-align: start;margin-top:10px;">
                      ...
                      @if ($order->restaurant)
                        ...
                        <div style="display:flex; align-items:center;margin-top:10px;">
                            ...
                            <img style="border:0;border-radius:50%;" src="{{dynamicStorage('/storage/app/public/restaurant/'.$order->restaurant->logo)}}" title=""
                    ...
                    <th style="width: 100%;">
                        @foreach ($social_media as $item)
                          <div style="display:inline-block;">
                            ...
                            <img src="{{dynamicAsset('public/assets/admin/img/'.$item->name.'.png')}}" alt="" style="height: 14px; width:14px; padding: 0px 3px 0px 5px;">
                            </a>
                          </div>
                        @endforeach
                    </th>
