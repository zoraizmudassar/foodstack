<!-- Nav -->
        <ul class="nav nav-tabs border-0 nav--tabs nav--pills pt-3">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/landing-page/available-zone*') ? 'active' : '' }}"
                href="{{ route('admin.landing_page.available_zone') }}">{{translate('messages.available_zone')}}</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.landing_page.backgroung_color') }}">{{translate('messages.Background_color')}}</a>
            </li>
