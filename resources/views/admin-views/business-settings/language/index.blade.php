                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$data['id']}}">
                                            <input type="checkbox"
                                            data-url="{{route('admin.language.update-status')}}"
                                            data-id="{{$data['code']}}"
                                            class="toggle-switch-input    {{ (array_key_exists('default', $data) && $data['default']==true) ? 'update-lang-status': 'status-update' }}" id="stocksCheckbox{{$data['id']}}" {{$data['status']==1?'checked':''}}>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="defaultCheck{{$data['id']}}">
                                            ...
                                            data-url="{{route('admin.language.update-default-status', ['code'=>$data['code']])}}"

                                            id="defaultCheck{{$data['id']}}" {{ ((array_key_exists('default', $data) && $data['default']==true) ? 'checked': ((array_key_exists('default', $data) && $data['default']==false) ? '' : 'disabled')) }}>
                                            <span class="toggle-switch-label mx-auto">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                    ...
                    <form action="{{route('admin.language.add-new')}}" method="post"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="direction1" class="col-form-label">{{translate('direction')}} :</label>
    ...
    <script>
     "use strict"
        $(".update-lang-status").click(function (e) {
                e.preventDefault();
                toastr.warning('{{translate('default_language_status_can_not_be_updated!_to_update_change_the_default_language_first!')}}');
        });
