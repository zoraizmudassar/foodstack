    ...
    <div class="content container-fluid">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal mb-4">
            <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
                <li class="nav-item">
                    <a href="{{ route('admin.subscription.subscriberDetail',$id) }}" class="nav-link ">{{ translate('Subscription_Details') }} </a>
                </li>
                <li class="nav-item">
        ...
        <div class="card mb-20">
            ...
            <form action="{{ route('admin.subscription.subscriberTransactions',$id) }}" method="get">
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="hs-unfold">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ route('admin.subscription.subscriberTransactionExport', [ 'id' =>$restaurant->id, 'export_type' => 'excel', request()->getQueryString()]) }}">
                            ...
                            <a id="export-csv" class="dropdown-item"
                                href="{{ route('admin.subscription.subscriberTransactionExport', [ 'id' =>$restaurant->id, 'export_type' => 'csv', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
