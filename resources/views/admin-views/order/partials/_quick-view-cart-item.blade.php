                ...
                <form id="add-to-cart-form" class="mb-2">
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        @if (isset($item_count) &&  $item_count <= 1 )
                            <button class="btn btn-sm btn--secondary w-40p" @disabled(true)
                                type="button">
                                <i class="tio-delete"></i>
                                {{ translate('messages.delete') }}
                            </button>
                        @else
                        <button class="btn btn-sm btn--danger w-40p removeFromCart" data-key="{{ $item_key }}"
                            type="button">
                            <i class="tio-delete"></i>
                            {{ translate('messages.delete') }}
                        </button>
                        @endif
                        <button class="btn btn-sm btn--primary w-40p add-To-Cart" type="button">
                            <i class="tio-edit"></i>
