...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
        <div class="px-4 text-lg tracking-wider w-full">

            <div class="text-center">
                <img src="{{dynamicAsset('/public/assets/admin/img/maintainance.svg')}}" alt="">
                <h4 class="mb-2">
                ...
                @if($selectedMaintenanceMessage['business_email'] || $selectedMaintenanceMessage['business_number'])
                    ...
                    <div>
                        @if($selectedMaintenanceMessage['business_number'])
                            <a href="tel:{{ $phone }}" class="link">{{ $phone }}</a><br>
                        @endif
                    </div>
                    <div>
                        @if($selectedMaintenanceMessage['business_email'])
